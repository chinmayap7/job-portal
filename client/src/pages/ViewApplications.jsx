                                        ...
                                        ? <div className='relative inline-block text-left'>
                                            ...
                                            {showAction === applicant._id && (
                                                <div className='z-10 absolute right-0 md:left-0 top-full mt-2 w-32 bg-white border border-gray-400 rounded shadow'>
                                                    ...
                                                    <button onClick={() => changeJobApplicationStatus(applicant._id, 'Rejected')} className='block w-full text px-4 py-2 text-red-500 hover:bg-gray-100 text-left'>Reject</button>
                                                </div>
                                            )}
                                        </div>
